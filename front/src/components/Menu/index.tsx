  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 text-center w-full max-w-4xl mt-10">
      ...
      {userProfile.premium === false ? (
        <div className="flex flex-col items-center">
          <div className="flex flex-col items-center justify-center p-4 bg-red-300 hover:bg-red-400 rounded-lg shadow-md w-40 h-40 transition-all duration-500">
      ...
      {userProfile.premium === false ? (
        <div className="flex flex-col items-center">
          <div className="flex flex-col items-center justify-center p-4 bg-red-300 hover:bg-red-400 rounded-lg shadow-md w-40 h-40 transition-all duration-500">
            <Image src={ImgAhorro} alt="Lograr metas" width={60} height={60} />
          </div>
