...
function ProgresoDeTusFinanzas() {
    ...
    return (
    <div className='flex flex-col items-center w-screen h-auto px-4 py-4 mt-6 md:pl-72 md:mr-4 bg-white shadow-md'>   
        
        <div className='flex flex-col md:flex-row md:justify-start  w-full'>
            <h2 className='mx-4 mb-4 font-bold text-2xl'>Progreso de tus finanzas</h2>
