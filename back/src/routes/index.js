...
router.get(
  "/incomesExpenses/calculatePaidPersonalLoans/:id",
  calculatorInconmeExpenses.calculatePaidPersonalLoans
);
router.get(
  "/incomesExpenses/calculatePaidVehicleLoans/:id",
  calculatorInconmeExpenses.calculatePaidVehicleLoans
);
router.get(
  "/incomesExpenses/calculateTotalHomeAndServicesExpenses/:id",
  calculatorInconmeExpenses.calculateTotalHomeAndServicesExpenses
);
router.get(
  "/incomesExpenses/calculateTotalFoodAndPersonalCareExpenses/:id",
  calculatorInconmeExpenses.calculateTotalFoodAndPersonalCareExpenses
);
router.get(
  "/incomesExpenses/calculateTotalVehicleExpenses/:id",
  calculatorInconmeExpenses.calculateTotalVehicleExpenses
);
router.get(
  "/incomesExpenses/calculateTotalTransportExpenses/:id",
  calculatorInconmeExpenses.calculateTotalTransportExpenses
);
router.get(
  "/incomesExpenses/calculateTotalMultipleCategoriesExpenses/:id",
  calculatorInconmeExpenses.calculateTotalMultipleCategoriesExpenses
);
router.get(
  "/incomesExpenses/calculateTotalVacationAndRecreationExpenses/:id",
  calculatorInconmeExpenses.calculateTotalVacationAndRecreationExpenses
);

router.get(
  "/incomesExpenses/totalincomeMonthly/:id",
  calculatorInconmeExpensesMonthly.calculateTotalIncomeMonthly
);
router.get(
  "/incomesExpenses/calculateMonthlyMortgageExpense/:id",
  calculatorInconmeExpensesMonthly.calculateMonthlyMortgageExpense
);
router.get(
  "/incomesExpenses/calculateMonthlyPersonalLoanExpense/:id",
  calculatorInconmeExpensesMonthly.calculateMonthlyPersonalLoanExpense
);
router.get(
  "/incomesExpenses/calculateMonthlyVehicleLoanExpense/:id",
  calculatorInconmeExpensesMonthly.calculateMonthlyVehicleLoanExpense
);
router.get(
  "/incomesExpenses/calculateMonthlyHomeAndServicesExpenses/:id",
  calculatorInconmeExpensesMonthly.calculateMonthlyHomeAndServicesExpenses
);
router.get(
  "/incomesExpenses/calculateMonthlyFoodAndPersonalCareExpenses/:id",
  calculatorInconmeExpensesMonthly.calculateMonthlyFoodAndPersonalCareExpenses
);
router.get(
  "/incomesExpenses/calculateMonthlyVehicleExpenses/:id",
  calculatorInconmeExpensesMonthly.calculateMonthlyVehicleExpenses
);
router.get(
  "/incomesExpenses/calculateMonthlyTransportExpenses/:id",
  calculatorInconmeExpensesMonthly.calculateMonthlyTransportExpenses
);
router.get(
  "/incomesExpenses/calculateMonthlyMultipleCategoriesExpenses/:id",
  calculatorInconmeExpensesMonthly.calculateMonthlyMultipleCategoriesExpenses
);
router.get(
  "/incomesExpenses/calculateMonthlyVacationAndRecreationExpenses/:id",
  calculatorInconmeExpensesMonthly.calculateMonthlyVacationAndRecreationExpenses
);
router.get(
  "/incomesExpenses/calculateMonthlyTithesAndSavings/:id",
  calculatorInconmeExpensesMonthly.calculateMonthlyTithesAndSavings
);
router.get(
  "/incomesExpenses/calculateMonthlyMiscellaneousExpenses/:id",
  calculatorInconmeExpensesMonthly.calculateMonthlyMiscellaneousExpenses
);
router.get(
  "/incomesExpenses/calculateMonthlyTotalExpenses/:id",
  calculatorInconmeExpensesMonthly.calculateMonthlyTotalExpenses
);
router.get(
  "/incomesExpenses/calculateNetIncomeMonthly/:id",
  calculatorInconmeExpensesMonthly.calculateNetIncomeMonthly
);
...
router.post(
  "/savings/simulate",
  calculatesavingsController.simulateSavingsPlan
);
